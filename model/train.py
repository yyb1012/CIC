"""
Batch-level training helpers used by train.py.
"""
...
def batch_level_train(model, graphs, train_loader, optimizer, max_epoch, device, n_dim=0, e_dim=0, verbose=False):
    epoch_iter = tqdm(range(max_epoch), disable=not verbose)
